        ...
        <DialogFooter>
          <div className="mt-10 flex w-full justify-between gap-2">
            <Button
              ...
              className="rounded-sm border-1 border-[var(--primary)] bg-white px-6 py-6 text-[#161CCA] hover:text-[#161CCA]"
              disabled={isPending}
            >
              Cancel
            </Button>
            <Button
              className="rounded-sm bg-[#161CCA] px-6 py-6 text-white hover:bg-[#161CCA]"
