...
export function AdminOtpForm({ onSubmit, email = "" }: AdminOtpFormProps) {
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          className={`flex w-full items-center justify-center gap-2 px-4 py-3 font-medium text-white transition-all duration-200 ${!isFormValid || isSubmitting
        ...
        <div className="flex flex-col items-center gap-6 justify-center">
          <span className="mt-2">
            Did’nt receive the email?  <span className="text-[#161CCA]"> Click here to resend</span>
          </span>
