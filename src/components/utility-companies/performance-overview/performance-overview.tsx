...
// Extend Node type to include fields for all node types
type Node = {
    name: string;
    type?: string; // e.g., "root", "region", "businessHub", "substation", "feederLine", "dss"
                    ...
                    <div className="flex items-center gap-0">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent side="bottom" align="center" sideOffset={4} avoidCollisions={false}>
                                ...
                                <DropdownMenuItem
                                    onClick={() => {
                                        /* Open dialog for adding Service Centre */
                                    }}
                                    className="cursor-pointer"
                                >
                                    <Wrench size={16} />
